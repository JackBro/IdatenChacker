...
#define DebugStringColor(form,field,hdc,x,y,font_s,r,g,b) {TCHAR disp_msg[100];swprintf((LPWSTR)disp_msg, TEXT(form), field),Str_Put(hdc, x, y, font_s, RGB(r, g, b), disp_msg);}
