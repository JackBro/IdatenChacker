...
class PAINT{
	...
	HBITMAP hb_Run00_Left = (HBITMAP)LoadImage(NULL, TEXT("run_000_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Run02_Left = (HBITMAP)LoadImage(NULL, TEXT("run_002_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Run04_Left = (HBITMAP)LoadImage(NULL, TEXT("run_004_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Run07_Left = (HBITMAP)LoadImage(NULL, TEXT("run_007_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Run11_Left = (HBITMAP)LoadImage(NULL, TEXT("run_011_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Run13_Left = (HBITMAP)LoadImage(NULL, TEXT("run_013_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);

	HBITMAP hb_Jump_Right = (HBITMAP)LoadImage(NULL, TEXT("run_007.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
	HBITMAP hb_Jump_Left = (HBITMAP)LoadImage(NULL, TEXT("run_007_left.bmp"),
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
