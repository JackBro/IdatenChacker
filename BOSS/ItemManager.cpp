...
void ItemManager::SetSpawnPoint(){
	...
	if (stageID == Stage1) {
		...
		int xy[13][2] = {
			{ 42 * CHIP_SIZE, 32 * CHIP_SIZE },
			{ 59 * CHIP_SIZE, 43 * CHIP_SIZE },
			{ 69 * CHIP_SIZE, 20 * CHIP_SIZE },
			{ 85 * CHIP_SIZE, 43 * CHIP_SIZE },
			{ 86 * CHIP_SIZE, 17 * CHIP_SIZE },
			{ 86 * CHIP_SIZE, 7 * CHIP_SIZE },
			{ 106 * CHIP_SIZE, 38 * CHIP_SIZE },
			{ 129 * CHIP_SIZE, 43 * CHIP_SIZE },
			{ 145 * CHIP_SIZE, 39 * CHIP_SIZE },
			{ 188 * CHIP_SIZE, 14 * CHIP_SIZE },
			{ 205 * CHIP_SIZE, 38 * CHIP_SIZE },
			{ 213 * CHIP_SIZE, 9 * CHIP_SIZE },
			{ 271 * CHIP_SIZE, 28 * CHIP_SIZE }
		};
		std::vector<int>n;
		for (int j = 0; j < 13; j++) {
			for (int i = 0; i < 2; i++) {
